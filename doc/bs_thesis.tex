...
\emph{trace}\footnote{A \emph{trace} a one enter point - multiple exit points sequence of instructions.}. Differently from the function instrumentation, it can happen here
that a more than one trace have the same BBL so, a preliminary check is necessary.
