...
\begin{lstlisting}[language={[x86masm]Assembler}, 
	label=out9, caption={a part of ``all basic blocks'' table}]

--------------------------------------------------------------------
All basic blocks
--------------------------------------------------------------------

block: {foo+24 at 16,0} addr: 0x0x8048418 simpleCounter: 1	
Disassembly: 
								       mov dword ptr [ebp-0xc], 0x0
								       jmp {foo+49 at 16,0}

block: {foo+33 at 17,0} addr: 0x0x8048421 simpleCounter: 3	
Disassembly: 
								       mov dword ptr [esp], 0x1
								       call p

block: {foo+45 at 16,0} addr: 0x0x804842d simpleCounter: 3	
Disassembly: 
								       add dword ptr [ebp-0xc], 0x1
								       cmp dword ptr [ebp-0xc], 0x2
								       jle {foo+33 at 17,0}

block: {foo+49 at 16,0} addr: 0x0x8048431 simpleCounter: 1	
Disassembly: 
								       cmp dword ptr [ebp-0xc], 0x2
								       jle {foo+33 at 17,0}

block: {foo+55 at 20,0} addr: 0x0x8048437 simpleCounter: 1	
Disassembly: 
								       mov dword ptr [esp], 0x0
								       call foo

block: {foo+67 at 20,0} addr: 0x0x8048443 simpleCounter: 1	
Disassembly: 
								       jmp {foo+81 at 25,0}
