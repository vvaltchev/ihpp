...
\noindent
Technically, \verb|ihppNodeChildrenContainer| is a macro which
\emph{actually} stands for \verb|ihppNodeChildrenContainerList1|.
...
As shown in \cref{doIns}, among many other things, this last function
calls \verb|insInstrumentation()| at every function instruction.
...
As \cref{ins} shows, when \verb|ins| is a \verb|ret|, the 
instruction is \emph{instrumented} with the \verb|funcMode_ret()| routine.
