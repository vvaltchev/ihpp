...
code\footnote{Usual empty lines of the source code \emph{are} included in this calculation}: 
even only copying down its full source code will require about 100 pages using
this text format.
