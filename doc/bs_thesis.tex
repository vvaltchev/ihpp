...
cost of the analysis routines. The first one depends by the way \textbf{Pin} 
...
and is the \emph{net} slowdown caused by IHPP; therefore, the slowdown measured should be
always compared to the \emph{empty analysis} slowdown.
