...
\noindent
As shown in \cref{doIns}, the above function
calls \verb|insInstrumentation()| at every routine instruction.
In fact, even if it is not shown above, it does many other operations 
