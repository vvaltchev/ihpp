...
two \emph{top} and \emph{bottom} pointers. After that, the \emph{top} and \emph{bottom} pointers and the \verb|reg_sp| variable are stored to the \emph{shadow stack}.
