...
\node[class, below right = 1.5cm and -1.3cm of genericCtx] (thCtx) {ThreadContextClass};
...
\Cref{globalCtx} shows a great part of the \verb|GlobalContextClass| implementation.
