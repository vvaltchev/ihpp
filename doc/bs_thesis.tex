...
%  every fit/.style = {draw, black, inner sep = 5pt, 
%						rectangle, rounded corners=10pt, thin, fill=none}]
flist/.style = {rectangle, rounded corners=6pt, thin, draw},
headnode/.style = {rectangle, fill=none, font=\small\bfseries}
]
...
\node[headnode, above = 0.2cm of n1] (t1) { Fundamental data classes };

\node[flist, minimum width = 5.2cm] (n2) at (7,0) {
\makecell[l] {
tracingObjects.h\\
traceObject.cpp
}};
...
\makecell[c] {
Tracing objects classes and\\
generic functions 
}};

\node[flist, minimum width = 5.2cm] (n3) at (0,-4.5) {
\makecell[l] {
tracingFuncs.h\\
funcMode.cpp\\
intraMode.cpp\\
...
\makecell[c] {
Working mode-specific\\
tracing functions
}};

\node[flist, minimum width = 5.2cm] (n4) at (7,-3.5) {
\makecell[l] {
ihpp.h\\
ihppContextClass.h\\
ihppThreadContextClass.h
}};
...
\node[flist, minimum width = 5.2cm] (n5) at (7,-6.5) {
\makecell[l] {
config.h\\
main.cpp
}};
...
\node[flist, minimum width = 5.2cm] (n6) at (0,-9) {
\makecell[l] {
util.h\\
util.cpp\\
output.h\\
...
\node[flist, minimum width = 5.2cm] (n7) at (7,-10) {
\makecell[l] {
options.h\\
options.cpp\\
benchmark.h\\
...
\node[rectangle, thin, draw, inner sep = 30pt, 
