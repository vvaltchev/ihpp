...
\makecell[l] {
ihpp.h\\
globalContextClass.cpp\\
threadContextClass.h\\
intraModeContext.h
}};
...
Nodes and forests concepts are implemented respectively in \verb|node.h| and \verb|forest.h|
files. The concept of \emph{tree} is not explicitly modeled in IHPP, but it is 
modeled inside the \verb|node<T>| class instead. Files in groups (1) and (2) 
...
to the \emph{quicker} \verb|traceObject| implementation, specially to speeding up 
the $k=\infty$ case.
