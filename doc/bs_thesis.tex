...
Let's start with an example\footnote{This example, like some other ones in this chapter, was taken, for simplicity, from the article \emph{k-Calling Context Profiling}.}: 
...
%A simple consideration can be made: some contexts (the ones market with *) are full-contexts, other ones aren't.
