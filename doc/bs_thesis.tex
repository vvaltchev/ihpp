...
\begin{center}
\verb|pin -t ihpp.so -ksf -kinf -funcMode -- ./prog1|
\end{center}

will produce as output a file called \verb|out.txt|\footnote{Some lines have been removed for compactness.}:


\begin{center}
\begin{tabular}{c}
\begin{lstlisting}[label=out1]
